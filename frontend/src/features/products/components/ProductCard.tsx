  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col p-6">
        ...
        <p className="mt-3 min-h-[40px] line-clamp-2 text-xs font-semibold leading-relaxed text-zinc-400">
          {product.description || "Không có mô tả chi tiết cho sản phẩm này."}
        </p>

        {/* Price tag summary */}
        <div className="mb-5 mt-5 flex items-center justify-between gap-3 rounded-2xl bg-zinc-50 border border-zinc-100/50 p-4">
          <span className="text-[9px] font-bold uppercase tracking-wider text-zinc-400">
            Đơn giá
          </span>
          <span
            className="text-sm font-black tracking-tight text-zinc-950"
