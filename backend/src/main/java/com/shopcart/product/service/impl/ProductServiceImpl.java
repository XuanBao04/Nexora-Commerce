...
import com.shopcart.common.service.CloudinaryService;
...
import com.shopcart.product.repository.ProductImageRepository;
...
public class ProductServiceImpl implements IProductService {
    ...
    @Transactional
    @CacheEvict(value = "products", allEntries = true)
    public Product createProduct(com.shopcart.product.dto.request.ProductFormRequest request) {
        // Always generate a time-ordered UUID v7 for new products
        String productId = com.shopcart.common.util.UUIDUtils.generateUUIDv7().toString();
    ...
    @Override
    @CacheEvict(value = "products", allEntries = true)
    public Product updateProduct(String productId, com.shopcart.product.dto.request.ProductFormRequest request) {
